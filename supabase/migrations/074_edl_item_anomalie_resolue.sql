...
--       + backfill des items passés à NULL par la migration 073

-- ─── 1. Nouveau statut enum ──────────────────────────────────────
ALTER TYPE edl_item_etat ADD VALUE IF NOT EXISTS 'ANOMALIE_RESOLUE';

-- ─── 2. Backfill : items remis à NULL par la migration 073 ───────
-- Ceux qui ont un incident RESOLU lié → ANOMALIE_RESOLUE
UPDATE edl_items ei
...
-- ─── 3. resolve_incident : ANOMALIE → ANOMALIE_RESOLUE ───────────
...
-- ─── 4. reopen_incident : ANOMALIE_RESOLUE → ANOMALIE ────────────
